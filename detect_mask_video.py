...
try:
    while True:
        ...
        if results.detections:
            for detection in results.detections:
                ...
                # Predict using __call__ instead of predict() for much faster FPS in real-time
                preds = maskNet(face, training=False).numpy()
    ...
    print("[INFO] Releasing webcam and destroying windows...")
    cap.release()
